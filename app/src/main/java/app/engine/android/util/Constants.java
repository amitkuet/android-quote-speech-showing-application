...
public class Constants {
    ...
    public final String API_BASE_URL = "http://www.mocky.io/";
    public final String GOOGLE_API_KEY = ""; //Please put your google api key here

    public final String[] EDIT_PROFILE_MENU_LIST = new String[] { "Personal Data", "Address", "Preferences", "Contact Information" };
}
